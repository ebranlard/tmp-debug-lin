...
300.0                  WtrDpth     - Water depth (m)
0.0                    MSL2SWL     - Offset between still-water level and mean sea level (m) [positive upward]
---------------------- INPUT FILES ---------------------------------------------
"../template/iea22_stab_09_ElastoDyn.dat" EDFile      - Name of file containing ElastoDyn input parameters (quoted string)
"../template/BD.dat" BDBldFile(1) - Name of file containing BeamDyn input parameters for blade 1 (quoted string)
"../template/BD.dat" BDBldFile(2) - Name of file containing BeamDyn input parameters for blade 2 (quoted string)
"../template/BD.dat" BDBldFile(3) - Name of file containing BeamDyn input parameters for blade 3 (quoted string)
"../template/iea22_stab_09_InflowFile.dat" InflowFile  - Name of file containing inflow wind input parameters (quoted string)
"../template/AD.dat" AeroFile    - Name of file containing aerodynamic input parameters (quoted string)
"../template/SvD.dat" ServoFile   - Name of file containing control and electrical-drive input parameters (quoted string)
"none" SeaStFile
...
1e-05                  TrimGain    - Proportional gain for the rotational speed error (>0) [used only if CalcSteady=True] (rad/(rad/s) for yaw or pitch; Nm/(rad/s) for torque)
100.0                  Twr_Kdmp    - Damping factor for the tower [used only if CalcSteady=True] (N/(m/s))
100.0                  Bld_Kdmp    - Damping factor for the blades [used only if CalcSteady=True] (N/(m/s))
