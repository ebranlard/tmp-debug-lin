...
---------------------- INPUT FILES ---------------------------------------------
"../template/iea22_stab_03_ElastoDyn.dat" EDFile      - Name of file containing ElastoDyn input parameters (quoted string)
...
"../template/iea22_stab_03_InflowFile.dat" InflowFile  - Name of file containing inflow wind input parameters (quoted string)
...
100.0                  TrimGain    - Proportional gain for the rotational speed error (>0) [used only if CalcSteady=True] (rad/(rad/s) for yaw or pitch; Nm/(rad/s) for torque)
