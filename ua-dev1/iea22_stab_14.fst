...
---------------------- INPUT FILES ---------------------------------------------
"../template/iea22_stab_14_ElastoDyn.dat" EDFile      - Name of file containing ElastoDyn input parameters (quoted string)
...
"../template/iea22_stab_14_InflowFile.dat" InflowFile  - Name of file containing inflow wind input parameters (quoted string)
